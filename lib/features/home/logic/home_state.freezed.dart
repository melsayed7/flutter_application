...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<DoctorsModel> doctorsModel) doctorsSuccess,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<DoctorsModel> doctorsModel)? doctorsSuccess,
...
abstract class _$$DoctorsSuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<DoctorsModel> doctorsModel});
}
...
class __$$DoctorsSuccessImplCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? doctorsModel = null,
  }) {
    return _then(_$DoctorsSuccessImpl(
      null == doctorsModel
          ? _value._doctorsModel
          : doctorsModel // ignore: cast_nullable_to_non_nullable
...
class _$DoctorsSuccessImpl implements DoctorsSuccess {
  const _$DoctorsSuccessImpl(final List<DoctorsModel> doctorsModel)
      : _doctorsModel = doctorsModel;

  final List<DoctorsModel> _doctorsModel;
  @override
  List<DoctorsModel> get doctorsModel {
    if (_doctorsModel is EqualUnmodifiableListView) return _doctorsModel;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_doctorsModel);
  }

  @override
  String toString() {
    return 'HomeState.doctorsSuccess(doctorsModel: $doctorsModel)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._doctorsModel, _doctorsModel));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_doctorsModel));
  ...
  TResult when<TResult extends Object?>({
    ...
    return doctorsSuccess(doctorsModel);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return doctorsSuccess?.call(doctorsModel);
  }
...
abstract class DoctorsSuccess implements HomeState {
  const factory DoctorsSuccess(final List<DoctorsModel> doctorsModel) =
